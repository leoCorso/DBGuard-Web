...
namespace DBGuardAPI.Data.Migrations
{
    ...
    [Migration("20260618184435_AnalyticsConsentEntity")]
    partial class AnalyticsConsentEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBGuardAPI.Data.Models.AnalyticsConsent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTimeOffset>("Timetsamp")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("timetsamp");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_analytics_consents");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_analytics_consents_user_id");

                    b.ToTable("analytics_consents", (string)null);
                });
            ...
            modelBuilder.Entity("DBGuardAPI.Data.Models.AnalyticsConsent", b =>
                {
                    b.HasOne("DBGuardAPI.Data.Models.User", "User")
                        .WithMany("AnalyticsConsents")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_analytics_consents_users_user_id");
            ...
            modelBuilder.Entity("DBGuardAPI.Data.Models.User", b =>
                {
                    b.Navigation("AnalyticsConsents");
