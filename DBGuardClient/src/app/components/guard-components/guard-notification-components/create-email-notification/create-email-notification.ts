...
import { EmailNotificationFormInfo } from '../../../../interfaces/notification-dto';
  ...
  providers: [
      {
        ...
        useExisting: forwardRef(() => CreateEmailNotification),
        multi: true
      }
    ]
})
export class CreateEmailNotification implements OnInit, OnDestroy, ControlValueAccessor {
